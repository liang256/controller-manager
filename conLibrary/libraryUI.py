...
class ControllerLibraryUI(QtWidgets.QDialog):
    ...
    def __init__(self):
        ...
        self.setWindowTitle('Controler Library UI')

        # The library varible points to an instance of our controller library
    ...
    def buildUI(self):
        ...
        # This is our child wedget that holds all the buttons
